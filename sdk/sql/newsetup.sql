...
DROP TABLE "public"."bsc_accounts";
CREATE TABLE "public"."bsc_accounts" (
  "uuid" char(36) NOT NULL,
  "private_key" text,
  "address" varchar(64),
  "created" timestamp(6),
...
CREATE TABLE "public"."client_accounts_eth" (
  ...
  "client_bsc_account_uuid" char(36), 
  "created" timestamp(6)
)
WITH (OIDS=FALSE);

DROP TABLE "public"."client_accounts_bsc";
CREATE TABLE "public"."client_accounts_bsc" (
  "uuid" char(36) NOT NULL,
  "bsc_address" varchar(64),
  "client_eth_account_uuid" char(36),
  "created" timestamp(6)
)
WITH (OIDS=FALSE);
...
DROP TABLE "public"."client_bsc_accounts";
CREATE TABLE "public"."client_bsc_accounts" (
  "uuid" char(36) NOT NULL,
  "private_key" text,
  "address" varchar(64),
  "created" timestamp(6),
...
CREATE TABLE "public"."tokens" (
  ...
  "bsc_to_eth_enabled" boolean,
  "eth_to_bsc_enabled" boolean
)
WITH (OIDS=FALSE);
